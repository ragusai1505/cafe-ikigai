    ...
    return (
      <AdminLayout>
        <div className="p-8 text-center">
          ...
          <button onClick={() => navigate('/admin')} className="mt-4 text-coffee-600 underline text-sm">Back to Dashboard</button>
        </div>
      </AdminLayout>
    )
  }
      ...
      <div className="p-8 max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-coffee-400 text-sm mt-0.5">{item.name}</p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input type="number" min="1" max="9999"
                  {...register('price', { required: 'Price required', min: { value: 1, message: 'Min ₹1' } })}
                  className="w-full px-4 py-3 border border-coffee-200 rounded-xl text-sm text-coffee-800 placeholder-coffee-300 focus:outline-none focus:ring-2 focus:ring-coffee-400/50 focus:border-coffee-400 transition-all" />
