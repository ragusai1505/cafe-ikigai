          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                <input
                  type="email"
                  placeholder="admin@cafeikigai.com"
                  autoComplete="email"
                  {...register('email', {
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-coffee-600 hover:bg-coffee-700 disabled:opacity-60 disabled:cursor-not-allowed text-white py-3.5 rounded-xl font-medium transition-all hover:shadow-lg hover:shadow-coffee-200 flex items-center justify-center gap-2 mt-2"
              >
                {loading ? (
            ...
            {/* Hint */}
            <div className="mt-6 p-4 bg-coffee-50 rounded-xl border border-coffee-100">
              <p className="text-coffee-500 text-xs font-mono text-center leading-relaxed">
                Default: admin@cafeikigai.com / admin123
              </p>
            </div>
